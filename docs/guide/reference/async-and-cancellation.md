...
>
> **Authority:** When an applicable action key selects this chapter into the compiled Context Pack, this chapter is the conditional async and cancellation contract. Source, tests, and gates own executable facts; root and nearest-local rules retain standing scope responsibility and local hard protection.
